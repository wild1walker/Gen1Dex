...
local src = assert(slurp("gen2area.lua"),
                   "gen2area.lua")
...
local Area = assert(loadfile("gen2area.lua"))()(mod, {})
...
do -- the eighteen columns are the box's business, not the provider's
  local Solo = assert(loadfile("gen2area.lua"))()(mod, {})
  ...
  local Pair = assert(loadfile("gen2area.lua"))()(mod, {})
...
do -- the row is live
  ...
  local Off = assert(loadfile("gen2area.lua"))()(off, {})
